      ...
      <section class="wrapper">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                     <th><i class=" fa fa-edit"></i>idPatient</th>
                    ...
                    <th><i class="fa fa-bullhorn"></i>Num tel</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Email</th>
                    <th><i class="fa fa-bookmark"></i>Date naissance</th>
          ...
          <tr data-expanded="true">
            ...
            <td><?php echo  $me['idpatient'] ;  ?></td>
             <td><?php echo  $me['id_rdv'] ;  ?></td>
            <td><?php echo  $me['nom_pat'] ;  ?></td>
            <td><?php echo  $me['prenom_pat'] ;  ?></td>
            
            <td><?php echo  $me['sexe'] ;  ?></td>
            <td><?php echo  $me['tel_pat'] ;  ?></td>
            <td><?php echo  $me['email_pat'] ;  ?></td>
            
            <td><?php echo  $me['date_nais'] ;  ?></td>
           <td>
                      <button class="btn btn-primary btn-xs" onclick="serviePatient(<?php echo  $me['idpatient'] ;  ?>,<?php echo  $me['id_rdv'] ;  ?>)">Servie</button>
                    </td> 
                  </tr>
                  <?php  endforeach ;    ?>
                </tbody>
